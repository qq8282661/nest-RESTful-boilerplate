...
export namespace nt_module_user {
    ...
    export interface UpdateUserInput {
         ...
         * @type {Array.<nt_module_user.UpdateUserInput.UpdateUserInfoKV>|undefined}
         */
        infoKVs?: nt_module_user.UpdateUserInput.UpdateUserInfoKV[];
    ...
    export namespace UpdateUserInput {
         ...
         * @exports nt_module_user.UpdateUserInput.UpdateUserInfoKV
         * @interface
         */
    ...
    export interface UpdateCurrentUserInfoRequest {
         ...
         * @type {nt_module_user.UpdateUserInput|undefined}
         */
        updateCurrentUserInput?: nt_module_user.UpdateUserInput;
    }
